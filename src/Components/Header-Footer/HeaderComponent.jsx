        ...
        <nav className="navbar navbar-expand-sm bg-dark navbar-dark" id="myTopnav">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar" >
              ...
              <React.Fragment>
                ...
                <li className="nav-item-float-right"><a href="/#" className="nav-link" >{AuthService.getUserData()['username']}</a></li>
              </React.Fragment>
              :
              <React.Fragment>
                <li className="nav-item-float-right"><a href="/sign-up" className="nav-link">Sign-up</a></li>
